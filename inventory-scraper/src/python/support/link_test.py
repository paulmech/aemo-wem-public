...
from support.link import (
    Link,
    _check_is_aemo_page,
    _create_summary_from_text_block,
    _create_anchor_from_text_block,
    _fetch_directory_from_url,
    create_dir_entry_objects,
)
...
def test_link_conversion():
    ...
    assert arr["is_directory"] is True
...
def test_anchor_parse_one():
    anchor = _create_anchor_from_text_block(
        """<a href="/scoobydoo" class="ng-angular">This is my text!</a>  ayye yo"""
    )
...
def test_create_links_from_content():
 ...
 <br>8/22/2029  5:59 PM        319424 <a href="/scoobydoo1/myfilename.txt" class="ng-angular">link three</a>
    ...
    assert links[2].fileCount is None
